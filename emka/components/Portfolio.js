		...
		<section className="py-12 sm:py-16 lg:py-20 bg-white">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="text-center mt-8 sm:mt-12">
					<button className="bg-primary hover:bg-white border-primary border-2 hover:text-primary text-white px-4 sm:px-6 py-2 sm:py-3 rounded-md font-medium transition duration-300 text-sm sm:text-base">
